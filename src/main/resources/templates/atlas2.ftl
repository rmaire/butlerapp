...
<html lang="en">
    <head>
        ...
        <script src="/webjars/github-com-vue-generators-vue-form-generator/vfg.js"></script>
        <link rel="stylesheet" href="/webjars/github-com-vue-generators-vue-form-generator/vfg.css">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div id="dynamic-form3">
                        <dynamic-form3></dynamic-form3>
                     </div>
