        ...
        <div class="container-fluid">
            <div class="row">
                <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="projects-nav" href="/projects">
                                    <span data-feather="globe"></span>
                                    Projekte <span class="sr-only">(current)</span>
                                    </a>
                                </li>
                            <li class="nav-item">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <!-- Main content here!-->
                    <form  class="command" action="/projects" method="post">
                        <h3 name="name">Select command to run</h3>
                        <div class="text-left">
                            <select class="custom-select custom-select-lg mb-3" id="templateselector" name="template">
